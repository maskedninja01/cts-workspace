...
public class EmployeeAPIIntegrationTest {
	...
	@Before
	public void setUp() {
		Employee emp = new Employee("Jason","Brody",80000,LocalDate.now(),Department.OPERATIONS,"8989898989","Jason@gmail.com");
		repository.save(emp);
	}
	...
	.andExpect(jsonPath("$[0].mobileNumber",is("8989898989")));
	}
}
